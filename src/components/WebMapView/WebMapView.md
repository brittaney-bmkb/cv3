...
- Layers list and Basemap widgets not connected to `WebMapComponentBeta`. 
  - new map component will be referenced in layer list widget see issue #269 
  - new map component will be referenced in basemap widget see issue #274 
